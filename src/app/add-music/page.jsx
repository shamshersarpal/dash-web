    ...
    <>
      ...
      <section className="mainDiv">
        ...
        <div className="flex items-center justify-center">
          ...
          <div className="flex items-center">
            ...
            {/* Line */}
            <div className="w-[50px] h-[2px] bg-gray-300" />
          </div>
          {/* Step 2 */}
          <div className="flex items-center">
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          ...
          <p className="text-center text-[#BBBBBB] text-small">
            Choose music for each chapter of their life.
          </p>
          ...
          <section className="grid grid-cols-2 gap-6 max-w-[850px] mx-auto mt-10">
            {/* Card 1 */}
            <div
              className="bg-[#282828] rounded-xl flex flex-col items-center justify-center lg:py-20 py-10 cursor-pointer hover:bg-[#2a2a2a] transition text-white"
              onClick={() => setIsOpen(true)}
            >
              {/* Same SVG from your original */}
              <svg
                width={56}
                height={56}
                viewBox="0 0 56 56"
              ...
              <h3 className="text-2xl font-medium mt-4">Childhood</h3>
              <p className="text-sm text-gray-400">Choose Song</p>
            </div>
            ...
            >
              ...
              <h3 className="text-2xl font-medium mt-4">Teenage</h3>
              <p className="text-sm text-gray-400">Choose Song</p>
            </div>
            ...
            >
              ...
              <h3 className="text-2xl font-medium mt-4">Recent</h3>
              <p className="text-sm text-gray-400">Choose Song</p>
            </div>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-center">
          {/* Overlay */}
          <div
            className="absolute inset-0 bg-[#40303090]"
            onClick={() => setIsOpen(false)}
          />
          {/* Bottom Sheet */}
          <div className="relative bg-[#121212] text-white w-full max-w-[850px] rounded-t-[40px] p-8 transform transition-transform duration-300 ease-out translate-y-0 shadow-2xl h-[80vh] overflow-y-auto border border-[#3F3F3F]">
            {/* Header */}
            <div className="flex justify-between items-center mb-4 ">
              <h2 className="text-lg font-mediam">Be Inspired by Music</h2>
              <button
            ...
            <input
              ...
              className="w-full mb-4 p-2 rounded bg-[#282828] text-white outline-none"
            />

            {/* Song List */}
            <div className="max-h-80 overflow-y-auto">
              {["Spotify API Data"].map((song, i) => (
                <div
                  key={i}
                  className="p-3 hover:bg-[#333333] rounded cursor-pointer"
                >
                  {song}
                </div>
              ))}
